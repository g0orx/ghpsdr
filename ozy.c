...
//fprintf(stderr,"ozy_send_buffer\n");
...
void process_bandscope_buffer(char* buffer) {
    short sample;
    int i;
//fprintf(stderr,"process_bandscope_buffer\n");
    for (i = 0; i < 512; i += 2) {
...
//fprintf(stderr,"process_bandscope_buffer: Spectrum\n");
...
//}
//fprintf(stderr,"process_ozy_input_buffer Control=%02X %02X %02X %02X %02X\n",
//        control_in[0],
//        control_in[1],
//        control_in[2],
//        control_in[3],
...
//fprintf(stderr,"fexchange2: rx0\n");
		...
		fexchange2(CHANNEL_RX0, left_input_buffer, right_input_buffer, left_output_buffer, right_output_buffer, &error);
                ...
                if(subrx) {
//fprintf(stderr,"fexchange2: subrx\n");
